...
class Cache{
    ...
    ******************************************/
    void rehash();
    void incrementHash();
    bool noDup(Person *&person);
    bool noInvalidID(int personID);
    Person* probingSearch(string key, int ID, Person** table) const;
    const Person people(Person*& person) const;
    bool linearProbing(Person* person, Person** table);
    bool quadraticProbing(Person* person, Person** table);
    bool doubleHashingProbing(Person* person, Person** table);
};
#endif